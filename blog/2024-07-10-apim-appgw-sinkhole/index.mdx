...
This is how you configure a sinkhole pool in Azure Application Gateway using Terraform, allowing you to offer both external and internal APIs through the gateway. You can also have a private listener with a different routing rile if you want to offer all the internal and external APIs to your internal consumers/networks.
