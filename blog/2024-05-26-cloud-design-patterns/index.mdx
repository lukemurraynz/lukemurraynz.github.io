...
graph TB
  ...
  UndoingOperationsInEventualConsistencyModels -- Yes --> UsePattern1[Use Compensating Transaction pattern]
  ...
  AvoidingComplexityOfDistributedTransactions -- Yes --> UsePattern5
