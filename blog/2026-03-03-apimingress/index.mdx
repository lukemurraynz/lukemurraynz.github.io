...
Most failure patterns occured were around:
...
### 2. To keep APIM private, allow public API access and have APIM zone-redundant - the following architecutre standards: AFD -> AppGw -> APIM (Internal).
