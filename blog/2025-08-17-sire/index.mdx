...
It’s worth noting that services such as [Azure Backup](https://learn.microsoft.com/azure/backup/backup-overview?WT.mc_id=AZ-MVP-5004796) are air-gapped and isolated from customer virtual networks - and can provide a secure recovery option in the event of a ransomware attack.
