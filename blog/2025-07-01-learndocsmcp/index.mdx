...
Because I have been specific about my prompt _(ie, use Microsoft Docs)_ Copilot was able to determine that it should call the Microsoft Learn MCP Server to ground the data with the response.
