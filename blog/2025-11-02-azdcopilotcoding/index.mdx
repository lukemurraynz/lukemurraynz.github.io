...
Hopefully this gives you a good overview of how to get started with the Azure Developer CLI `azure.coding-agent` extension to enable the GitHub Copilot Coding Agent to access Azure resources securely and efficiently. In my article I showed how you can generate and deploy resources directly in Azure, but this opens up a lot of possibilities for automating your Azure development workflows using AI-powered assistance — infrastructure as code generation of existing resources, Azure resource reviews, and even troubleshooting assistance directly within your development environment.

Follow the principle of least privilege when configuring the managed identity and role assignments to keep your Azure resources secure while using the GitHub Copilot Coding Agent. You don't want to give this agent more permissions than it needs for the tasks at hand! Remember to monitor and audit the Coding Agent's activities to maintain compliance and security in your Azure environment.
