...
You can find the full code for this, in the [lukemurraynz/Hackathon](https://github.com/lukemurraynz/Hackathon). Feel free to open a PR _(Pull Request)_, if you have any suggestions or improvements.
