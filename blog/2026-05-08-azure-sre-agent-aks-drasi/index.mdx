...
:::note
The full source is at [lukemurraynz/drasi-aks-sre-agent](https://github.com/lukemurraynz/drasi-aks-sre-agent/) on GitHub. Everything in this post deploys from that repo with `azd up`.
:::
