...
You can also find the latest files in the [lukemurraynz/ADO_Export](https://github.com/lukemurraynz/ADO_Export) GitHub repository. Pull Requests, suggestions, and improvements are welcome.
...
Time to import the pipeline and configure the variables.
