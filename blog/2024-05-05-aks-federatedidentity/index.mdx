...
:::tip
There is a lot of detail around identity and federated and workload identity that I won't be going into today.
...
To test that its open, you can navigate to the URL discovery endpoint '/openid/v1/jwks', for example:
