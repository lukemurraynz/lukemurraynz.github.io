...
Hopefully, that's given you the base to work from; you could add logic around if a file from x user, do this, or notify the user of receipt based on a map lookup, etc.
