...
Hopefully thats given you the base to work from, you could potentially add logic around if file from x user, do this, or notify user of receipt based on a map lookup etc
