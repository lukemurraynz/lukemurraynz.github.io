---
title: Authenticating Azure OpenAI with API Key and Managed Identities in Python
...
authors:
  - Luke
slug: azure/authenticating-azure-openai-python
keywords:
  - azure
...
When developing a python application that interacts with [Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/overview?WT.mc_id=AZ-MVP-5004796), you may want to authenticate with an API key for testing, but in Production you should make use of Managed Identities within Microsoft Azure.
