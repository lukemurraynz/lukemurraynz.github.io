...
hub_and_spoke_vnet_virtual_networks = {
  ...
  /* Commenting out the bastion section as it is not required for the hub virtual network at the time of deployment. To be added back in when Bastion required.
      bastion = {
