...
[Drasi](https://drasi.io/), a CNCF Sandbox project for continuous queries over changing data, handles a question SQL cannot express well: "alert me when something *stops* happening." I have been testing it against a real AKS cluster and Azure Database for PostgreSQL.
