...
:::info
If you get the following error: `Failed to push OCI artifact to ACR: Issue retrieving session url: {'errors': [{'code': 'UNAUTHORIZED', 'message': 'authentication required, visit https://aka.ms/acr/authorization for more information.', 'detail': [{'Type': 'repository', 'Name': 'csscpolicies/patchpolicy', 'Action': 'pull'}, {'Type': 'repository', 'Name': 'csscpolicies/patchpolicy', 'Action': 'push'}]}]}`
...
Then you need to run the following command to give your ACR the correct permissions:
