...
keywords:
  ...
  - Technical Writing
  - Visual Studio Code
description: Explore Microsoft Learn Contributor Chat mode to enhance your documentation skills while adhering to the Microsoft Writing Style Guide.
...
Testing it with a markdown file about Azure Container Apps:

![Learn Docs Contributor Chatmode Test](images/LearnDocsContributorChatMode.gif)
