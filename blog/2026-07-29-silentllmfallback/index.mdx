...
It wasn't one thing. There were three separate bugs, each independently harmless, each invisible on its own. Stack them together and everything - but it still looks fine from the outside.
