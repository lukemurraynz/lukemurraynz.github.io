...
I also captured a real deploy and rollout check. This is not a mocked terminal recording - it came from `azd deploy`, `kubectl wait`, and the current HPA state.
...
- [AKS network concepts and security](https://learn.microsoft.com/en-us/azure/aks/concepts-network)
- [Bicep language overview](https://learn.microsoft.com/en-us/azure/azure-resource-manager/bicep/overview)
- [HTTPS ingress on AKS with cert-manager](https://learn.microsoft.com/en-us/azure/aks/ingress-tls)
...
- [Azure NAT Gateway overview](https://learn.microsoft.com/en-us/azure/nat/nat-overview)
- [Workload Identity on AKS](https://learn.microsoft.com/en-us/azure/aks/workload-identity-overview)

**Data Services:**

- [Azure Cache for Redis with private endpoints](https://learn.microsoft.com/en-us/azure/azure-cache-for-redis/cache-how-to-premium-vnet)
