...
Key policies are part of the ALZ Sandbox Guardrails, essentially the policies to restrit the deployment of network resources, that would allow you to link virtual networks to on-premises, peer to other virtual networks that would allow Sandbox users to connect to prodution virtual networks, or virtual networks outside of the control of your organisation.
...
This is where alot of automation comes into play, to prevent drift and inconsistencies, with the creation *(and decommission)* of a Sandbox environment.
