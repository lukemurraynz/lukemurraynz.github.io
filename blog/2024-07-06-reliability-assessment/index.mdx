...
## 📊 Azure Proactive Resiliency Library - Resiliency Reports
...
> You can do both the data collection in an Azure CloudShell, which is useful for running this in customer environments; however, to create and analyze the data, you will need to run the script from a computer that has Word and Excel installed.
...
If you used CloudShell in the previous step, you will need to download the JSON file to your local machine to run the Data Analyzer script.
...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Recommendations   | You will find all Recommendations, their category, impact, description, learn more links, and much more. Note that Columns A and B count the number of Azure Resources associated with RecommendationID. |
