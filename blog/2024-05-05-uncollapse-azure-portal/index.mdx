...
description: Learn how to keep the Azure Portal Blade Menu always open for easy access to new services and options.
...
![Azure Portal - Collapse Resource Blade Menu](AzurePortal_CollapseableResource.png)
