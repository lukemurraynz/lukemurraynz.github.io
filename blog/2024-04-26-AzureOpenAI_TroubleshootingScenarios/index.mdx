...
The idea of this article is to give you not only a place to start with some common scenarios you may run into but also a way of thinking - to help you troubleshoot. This is not an technical 'get-your-hands dirty, delve into those logs' type article.

I am a big fan of the KT, or [Kepner-Tregoe](https://kepner-tregoe.com/) problem analysis methodology and I have used it in many scenarios throughout my career to helping discover and test the root cause of various problems. So, we will use the base of this problem analysis methodology to help us troubleshoot the scenarios we will discuss in this article.
