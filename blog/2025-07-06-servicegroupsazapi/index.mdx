...
If you’ve ever struggled with managing sprawling applications across multiple resource groups, subscriptions, and teams, Service Groups address that directly.
...
* Visualize health and operational state across the full workload
...
> It’s still early days, but the flexibility, clarity, and insight Service Groups bring are already useful in practice. If you're managing large Azure estates, [sign up for the preview](https://aka.ms/sgp), test it out, and give feedback to help shape what’s next.
