...
With Service Group members being created for each of the service groups, in this example I have created a Storage Account as a member of Identity and Access management Service Group, and a Resource Group called openai as a member of E-commerce Platform _(which includes resources inside that group by default)_.
