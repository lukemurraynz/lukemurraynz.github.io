...
| **Element**                                                                                                   | **Description**                                                                                                                                                                                |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <trace source="Global APIM Policy" severity="information">  </trace>                                              | This is the start of a trace element. The source attribute is set to "Global APIM Policy" and the severity attribute is set to "information".                                              |
