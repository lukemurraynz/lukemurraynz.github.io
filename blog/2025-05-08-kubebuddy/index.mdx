...
:::tip
You can do a compare of 2 different reports to see if you are going up and down:
...
Then run a script similar to below to create a comparison file:
