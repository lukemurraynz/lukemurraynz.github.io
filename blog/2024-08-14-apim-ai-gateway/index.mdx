...
These capabilities are designed to help secure and monitor your OpenAI endpoints for use in your applications as you head toward production.
...
* _(optionally)_ Policies are used to help you monitor and manage token consumption using the Azure OpenAI API.
...
Add in your deployment id and api version, and in the request body, enter in a sample prompt like below:
