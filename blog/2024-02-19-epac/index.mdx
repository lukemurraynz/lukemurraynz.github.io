...
So, let's look a little further into it.
...
We are going to use the EPAC [StarterKit](https://github.com/Azure/enterprise-azure-policy-as-code/tree/main/StarterKit), for the pipelines and scripts.
