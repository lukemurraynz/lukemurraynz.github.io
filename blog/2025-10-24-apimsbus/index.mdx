...
The policy executes and sends the payload as a message to Service Bus. 
...
<policies>
    ...
    <inbound>
        <send-service-bus-message queue-name="apimsbqueue" namespace="sbapimtest.servicebus.windows.net">
            <message-properties>
