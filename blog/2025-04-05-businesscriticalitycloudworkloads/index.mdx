...
This post covers workload criticality, methods to assess how critical your workload is, and the ramifications of that criticality in the cloud.
...
Let us look at the [Reliability](https://learn.microsoft.com/azure/well-architected/reliability/?WT.mc_id=AZ-MVP-5004796) and Availability of these workloads by looking at the [Shared responsibility model](https://learn.microsoft.com/azure/reliability/concept-shared-responsibility?WT.mc_id=AZ-MVP-5004796).
...
So, let's look a little deeper into SLAs and how they relate to the criticality of your workload.
