...
You could have this built into the container itself, which may be preferred to keep a consistent experience, but you can update the container environment.
