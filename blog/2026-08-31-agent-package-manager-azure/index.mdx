...
This is important because APM policy is an **install-time and CI governance mechanism**, not a replacement for runtime security or agent sandboxing. Runtime permissions still belong to the agent harness and the underlying platform. [APM policy documentation](https://microsoft.github.io/apm/enterprise/apm-policy-getting-started/)
