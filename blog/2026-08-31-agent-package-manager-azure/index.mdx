---
title: "Agent Package Manager: the missing package.json for AI-assisted Azure engineering"
...
description: "A practical view of using APM to make agent skills, MCP servers, lockfiles, and policy governable rather than copy-pasted."
